  ...
  <div class="space-y-10 px-20">
    <div class="flex justify-center">
      <n-carousel autoplay mx-auto>
        <img
          ...
          a
          href
          link="https://www.youtube.com/watch?v=1rp8royyiQ8"
        />
        <img
          class="carousel-img mx-auto w-full rounded-lg"
    ...
    <div class="rounded-lg overflow-hidden flex justify-center items-center relative h-60">
      ...
      <div class="px-20 z-10 relative text-center">
        ...
        <br />
        <n-button strong secondary @click="$router.push('/auth/login')" type="primary">
          Login Sekarang
        </n-button>
      </div>
    </div>
        ...
        <ul class="grid gap-4 mt-8 sm:grid-cols-2 lg:grid-cols-4">
          <li>
            <a href="#" class="block overflow-hidden group">
              <img src="@/assets/images/landingpage/cover3.jpg" class="" />

              <div class="relative pt-3 bg-white">
                <n-text>Menggunakan Bahasa Inggris Bagi Calon Sekretaris</n-text>
                <p class="mt-2">
                  <n-gradient-text type="info"> Rp.1.500.000 </n-gradient-text>
                </p>
                <n-button strong secondary round type="primary" width="50px" height="50px">
                  Beli Kelas Online
                </n-button>
              </div>
            </a>
          ...
          <li>
            <a href="#" class="block overflow-hidden group">
              <img src="@/assets/images/landingpage/cover2.jpg" alt="" class="" />

              <div class="relative pt-3 bg-white">
                <n-text
                  >Melakukan Komunikasi Bahasa Inggris Melalui Panggilan Telepon Bagi Calon Petugas
                  Informasi Pusat Kontak</n-text
                >
          ...
          <li>
            <a href="#" class="block overflow-hidden group">
              <img src="@/assets/images/landingpage/cover1.jpg" alt="" class="" />

              <div class="relative pt-3 bg-white">
                <n-text
                  >Melakukan Riset Kata Kunci dan Optimasi SEO Website Untuk Menjadi Manajer
                  Pemasaran</n-text
                >
          ...
          <li>
            <a href="#" class="block overflow-hidden group">
              <img src="@/assets/images/landingpage/cover4.jpg" alt="" class="" />

              <div class="relative pt-3 bg-white">
                <n-text
                  >Mengolah Data Penjualan dengan Microsoft Excel untuk Menjadi Admin Input
                  Data</n-text
                >
