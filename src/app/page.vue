  ...
  <div class="space-y-10 px-20">
    <div class="flex justify-center">
      <n-carousel autoplay mx-auto>
        <img class="carousel-img mx-auto w-full rounded-lg" src="@/assets/images/landingpage/tutor_redeem.png" />
        <img class="carousel-img mx-auto w-full rounded-lg" src="@/assets/images/landingpage/super-admin.jpg" />
        <img class="carousel-img mx-auto w-full rounded-lg" src="@/assets/images/landingpage/Desktop-1.png" />
        <img class="carousel-img mx-auto w-full rounded-lg" src="@/assets/images/landingpage/Desktop-2.png" />
        <img class="carousel-img mx-auto w-full rounded-lg" src="@/assets/images/landingpage/Desktop-3.png" />
      </n-carousel>
    </div>

    <div v-if="!auth" class="rounded-lg overflow-hidden flex justify-center items-center relative h-60">
      <img class="absolute right-0 z-0 w-full h-full object-cover" src="@/assets/images/landingpage/bg-login.png"
        alt="" />
      <div class="px-20 z-10 relative text-center">
        ...
        <br />
        <n-button strong secondary type="primary"> Login Sekarang </n-button>
      </div>
    </div>
      ...
      <div class="max-w-screen-xl px-4 py-8 mx-auto sm:px-6 sm:py-12 lg:px-8">
        ...
        <div class="grid gap-4 mt-8 sm:grid-cols-2 lg:grid-cols-4">
          <template v-for="product in classes?.data[0]?.programs" :key="product">
            <product-card :id="product.id" :title="product.title" :price="product.program_information.selling_price"
        ...
        <div class="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8">
          <blockquote class="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
            <div class="flex items-center gap-4">
              ...
              <div>
                ...
                <p class="mt-0.5 text-lg font-medium text-gray-900">Irvan Alfian</p>
              </div>
            </div>
          ...
          <blockquote class="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
            ...
            <p class="mt-4 text-gray-700">
              ...
              Inggris,mentornya juga super asik jadi suasana belajarnya ga ngebosenin dan nyenengin
            </p>
          </blockquote>
          ...
          <blockquote class="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
            <div class="flex items-center gap-4">
              ...
              <div>
                ...
                <p class="mt-0.5 text-lg font-medium text-gray-900">Yoga Erno</p>
              </div>
            </div>

            <p class="mt-4 text-gray-700">
              Alhamdullilah,menyenang sekali kegiatan pelatihannya selain materi yang bervariatif
              dan sangat bermanfaat sekali digunakan untuk menghadapi dunia kerja nanti, pematerinya
              juga menyampaikan materi dengan sangat komunikatif sehingga mudah diterima oleh
              peserta.
            </p>
          </blockquote>
        </div>
