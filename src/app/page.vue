    ...
    <ul class="grid gap-4 mt-8 sm:grid-cols-2 lg:grid-cols-4">
      <li>
        <a href="#" class="block overflow-hidden group">
          <img
          src="@/assets/images/landingpage/cover3.jpg"
            class=""
          />
      ...
      <li>
        <a href="#" class="block overflow-hidden group">
          <img
          src="@/assets/images/landingpage/cover2.jpg"
            alt=""
            class=""
          />

          <div class="relative pt-3 bg-white">
          <n-text>Melakukan Komunikasi Bahasa Inggris Melalui Panggilan Telepon 
            Bagi Calon Petugas Informasi Pusat Kontak</n-text>
      ...
      <li>
        <a href="#" class="block overflow-hidden group">
          <img
          src="@/assets/images/landingpage/cover1.jpg"
            alt=""
            class=""
          />

          <div class="relative pt-3 bg-white">
          <n-text>Melakukan Riset Kata Kunci dan Optimasi SEO Website Untuk Menjadi Manajer Pemasaran</n-text>
      ...
      <li>
        <a href="#" class="block overflow-hidden group">
          <img
          src="@/assets/images/landingpage/cover4.jpg"
            alt=""
            class=""
          />

          <div class="relative pt-3 bg-white">
          <n-text>Mengolah Data Penjualan dengan Microsoft Excel untuk Menjadi Admin Input Data</n-text>
