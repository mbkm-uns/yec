...
<div class="max-w-screen-xl mx-auto">
    <n-card>
        ...
        <br>
        <br>
        <n-text class="mt-6 max-w-lg leading-relaxed text-gray-700 font-normal text-xl">PT Yureka Edukasi Cipta yang memiliki nama brand YEC CO ID berdiri pada tahun 2010
            dengan nama awal Euraka Tour, sebuah layanan jasa tour spesialis Kampung Inggris.
            Saat ini YEC fokus membantu setiap peserta menjadi individu lebih baik.
            Tidak hanya sebatas menjadi jasa tour,namun juga menjadi konsultan pendidikan dan media yang membantu
            menjadikan diri lebih baik dengan kemudahan akses informasi dan program pelatihan terkait tes TOEFL,IELTS,
            Persiapan Kerja dan Pembelajaran Bahasa Inggris sehari-hari.
        </n-text>
        <br>
        <br>
        <n-text class="mt-6 max-w-lg leading-relaxed text-gray-700 font-normal text-xl">Serta pada tahun 2020,YEC CO ID bergabung bersama program Kartu Prakerja,memberikan pelatihan kepada peserta
            kartu prakerja yang memiliki keinginan untuk mengembangkan keahlian agar lebih percaya diri terjun ke dunia kerja,maupun membuat usaha
        </n-text>
    </n-card>
            ...
            <div class="space-y-4">
                <details class="group [&_summary::-webkit-details-marker]:hidden" open>
                    ...
                    <p class="mt-4 px-4 leading-relaxed text-gray-700 text-lg">
                        ...
                        dan kewirausahaan yang ditujukan untuk pencari kerja, pekerja/buruh yang terkena
                        pemutusan hubungan kerja, dan/atau pekerja/buruh yang membutuhkan peningkatan kompetensi,
                        termasuk pelaku usaha mikro dan kecil. Kami percaya bahwa masyarakat Indonesia sesungguhnya
                        ingin selalu meningkatkan kemampuannya. Program ini didesain sebagai sebuah produk dan dikemas
                        sedemikian rupa agar memberikan nilai bagi pengguna sekaligus memberikan nilai bagi sektor swasta
                    </p>
                    <p class="mt-4 px-4 leading-relaxed text-gray-700 text-lg">
                        Jalan digital melalui marketplace dipilih untuk memudahkan pengguna mencari,membandingkan,memilih dan
                        memberi evaluasi. Hanya dengan cara ini, produk bisa terus diperbaiki,tumbuh dan relevan. Menggandeng pelaku
                        usaha swasta,program ini adalah wujud kerjasama pemerintah dan swasta dalam melayani masyarakat dengan semangat
                ...
                <details class="group [&_summary::-webkit-details-marker]:hidden" open>
                    ...
                    <p class="mt-4 px-4 leading-relaxed text-gray-700 text-lg">
                        ...
                        peserta yang ingin belajar Bahasa Inggris
                        khususnya bagi yang berprofesi sebagai Sekretaris.
                        Pelatihan ini menggunakan metode ajar webinar. Kelas ini merujuk pada SKKNI Nomor 27 Tahun 2009.
                    </p>
                    <p class="mt-4 px-4 leading-relaxed text-gray-700 text-lg">
                        Peserta akan mendapatkan pengetahuan tentang menggunakan Bahasa Inggris bagi seorang calon sekretaris meliputi perkenalan
                        okupasi sekretaris, cakupan tugas, dan pentingnya belajar Bahasa Inggris bagi sekretaris, orang-orang di tempat kerja (people at work),
                        membuat dan menerima panggilan (making and receiving calls), menerima dan memberi pesan (taking and giving messages), menyambut dan menerima
                        tamu (welcoming and receiving visitors), dan membuat surat, memo, dan permohonan (letters, inter-office memos, and requests) mengingat banyaknya
                    ...
                    <p class="mt-4 px-4 leading-relaxed text-gray-700 text-lg">
                        ...
                        ingin belajar Bahasa Inggris khususnya bagi yang berprofesi sebagai tenaga perkantoran umum. Pelatihan ini
                        menggunakan metode ajar webinar. Kelas ini merujuk pada SKKNI Nomor 183 Tahun 2016 Administrasi Profesional.
                    </p>
                    <p class="mt-4 px-4 leading-relaxed text-gray-700 text-lg">
                        Peserta akan mendapatkan pengetahuan tentang menggunakan Bahasa Inggris bagi seorang calon tenaga perkantoran umum
                        meliputi perkenalan okupasi tenaga perkantoran umum, cakupan tugas, dan pentingnya belajar Bahasa Inggris bagi calon
                        tenaga perkantoran umum, bertemu kolega/pelanggan (small talks/basic conversation), membuat-menerima panggilan dan memberikan
                        pesan secara lisan (making-receiving calls and taking a message), meminta dan memberikan saran/usul (asking and giving opinions)
                        meminta dan memberikan klarifikasi (asking for clarification and clarifying one's idea), surat dan pengumuman (letters and announcement)
                        mengingat banyaknya perusahaan multinasional yang terdapat di Indonesia serta pentingnya penguasaan Bahasa Inggris sebagai bahasa internasional.
                    </p>
                    <p class="mt-4 px-4 leading-relaxed text-gray-700 font-semibold text-xl">
                    ...
                    <p class="mt-4 px-4 leading-relaxed text-gray-700 text-lg">
                        Melakukan Komunikasi Bahasa Inggris Melalui Panggilan Telepon Bagi Calon Petugas Informasi Pusat Kontak adalah kelas yang disusun khusus untuk peserta yang ingin belajar
                        Bahasa Inggris khususnya bagi yang berprofesi sebagai Petugas Informasi Pusat Kontak. Pelatihan ini menggunakan metode ajar webinar. Kelas ini merujuk pada SKKNI Nomor 27
                        Tahun 2009 Tentang Bahasa Inggris Tenaga Administrasi Profesional
                    </p>
                    <p class="mt-4 px-4 leading-relaxed text-gray-700 text-lg">
                        Peserta akan mendapatkan pengetahuan tentang menggunakan Bahasa Inggris bagi seorang calon Petugas Informasi Pusat Kontak meliputi perkenalan okupasi Petugas Informasi Pusat Kontak,
                        cakupan tugas, dan pentingnya belajar Bahasa Inggris bagi Petugas Informasi Pusat Kontak, menggunakan bahasa Inggris untuk melayani pelanggan atau konsumen, menggunakan bahasa Inggris
                        untuk menjawab telepon dalam melayani pelanggan atau konsumen, menginterpretasikan informasi yang diterima dan memiliki kemampuan komunikasi yang efektif, menunjukkan sikap komunikatif dalam berbahasa Inggris,
                        menunjukkan sikap terampil dalam penggunaan peralatan komunikasi mengingat banyaknya perusahaan multinasional yang terdapat di Indonesia serta pentingnya penguasaan Bahasa Inggris sebagai bahasa internasional.
                    </p>
                    <p class="mt-4 px-4 leading-relaxed text-gray-700 font-semibold text-xl">
                    ...
                    <p class="mt-4 px-4 leading-relaxed text-gray-700 text-lg">
                        ...
                        metode ajar webinar. Kelas ini merujuk pada SKKNI Nomor 389 Tahun 2013 Tentang Penetapan Standar Kompetensi Kerja Nasional Indonesia Kategori Jasa Profesional, Ilmiah Dan Teknis, Golongan Pokok Kegiatan Kantor Pusat
                        Dan Konsultasi Manajemen, Golongan Konsultasi Manajemen, Sub Golongan Konsultasi Manajemen Area Kerja Pemasaran.
                    </p>
                    <p class="mt-4 px-4 leading-relaxed text-gray-700 text-lg">
                        Peserta akan mendapatkan pengetahuan tentang riset kata kunci dan optimasi SEO website untuk menjadi manajer pemasaran, cakupan tugas, okupasi manajer pemasaran dan pentingnya riset kata kunci dan optimasi SEO Website,
                        pengenalan SEO dalam Digital Marketing, membangun website, menulis konten, teknik SEO on page dan offpage, dan audit SEO.
                    </p>
                    <p class="mt-4 px-4 leading-relaxed text-gray-700 font-semibold text-xl">
                    ...
                    <p class="mt-4 px-4 leading-relaxed text-gray-700 text-lg">
                        ...
                        Kelas ini merujuk pada SKKNI Nomor 183 Tahun 2016 tentang Tenaga Administrasi Profesional dan SKKNI Nomor 27 Tahun 2009 tentang Bahasa Inggris Tenaga Administrasi Profesional.
                    </p>
                    <p class="mt-4 px-4 leading-relaxed text-gray-700 text-lg">
                        Peserta akan mendapatkan pengetahuan tentang menggunakan Bahasa Inggris bagi calon staf legal meliputi penggunaan kosa kata Bahasa Inggris yang terdapat pada surat perjanjian kerjasama dalam Bahasa Inggris, penggunaan istilah yang
                        terdapat dalam surat perjanjian kerjasama berbahasa Inggris, penggunaan grammar (Simple present, Simple Future, dan Passive Voices) bahasa Inggris sederhana yang terdapat pada surat perjanjian kerjasama berbahasa Inggris, penggunaan
                        kosakata dan grammar bahasa Inggris sederhana untuk menyusun surat perjanjian kerja sama dalam bahasa Inggris, dan penggunaan sikap komunikatif (pemberian saran/masukan/pendapat) mengenai isi surat perjanjian kerjasama dengan menggunakan bahasa Inggris.
                    </p>
                    <p class="mt-4 px-4 leading-relaxed text-gray-700 font-semibold text-xl">
                    ...
                    <p class="mt-4 px-4 leading-relaxed text-gray-700 text-lg">
                        ...
                        Pelatihan ini menggunakan metode ajar webinar. Kelas ini merujuk pada SKKNI Nomor 56 Tahun 2018.
                    </p>
                    <p class="mt-4 px-4 leading-relaxed text-gray-700 text-lg">
                        Peserta akan mendapatkan pengetahuan tentang menggunakan Microsoft Excel untuk Menjadi Admin Input Data meliputi Pengenalan Microsoft Excel dan Formula Dasar Microsoft Excel: Formula Dasar, Formula Dasar Microsoft Excel: Formula Lanjutan, Mengatur dan Merapikan Data Penjualan,
                        Mengolah Data Penjualan Menggunakan Seri Formula IF, Mengolah Data Penjualan Menggunakan Formula Look Up dan Pivot Table.
                    </p>
                    <p class="mt-4 px-4 leading-relaxed text-gray-700 font-semibold text-xl">
                    ...
                    <p class="mt-4 px-4 leading-relaxed text-gray-700 text-lg">
                        ...
                        Kelas ini merujuk pada SKKNI Nomor 182 Tahun 2013.
                    </p>
                    <p class="mt-4 px-4 leading-relaxed text-gray-700 text-lg">
                        Peserta akan mendapatkan pengetahuan tentang menggunakan microsoft excel untuk menjadi staf akuntan meliputi pengenalan okupasi beserta cakupan tugas staf akuntansi dan pengenalan siklus akuntansi, logika akuntansi dan siklus akuntansi (jurnal umum dan jurnal khusus), siklus akuntansi
                        (berupa neraca saldo, neraca lajur, ayat jurnal penyesuaian dan neraca saldo setelah penyesuaian, membuat sistem akuntansi menggunakan microsoft excel dan menyusun laporan keuangan (memproses data dan menyajikan laporan keuangan).
                    </p>
                    <p class="mt-4 px-4 leading-relaxed text-gray-700 font-semibold text-xl">
                    ...
                    <p class="mt-4 px-4 leading-relaxed text-gray-700 text-lg">
                        ...
                        SKKNI Nomor 149 Tahun 2020 Tentang Manajemen Sumber Daya Manusia
                    </p>
                    <p class="mt-4 px-4 leading-relaxed text-gray-700 text-lg">
                    ...
                    <p class="mt-4 px-4 leading-relaxed text-gray-700 text-lg">
                        ...
                        27 Tahun 2009 Bahasa Inggris untuk Tenaga Administrasi Profesional
                    </p>
                    <p class="mt-4 px-4 leading-relaxed text-gray-700 text-lg">
                        Peserta akan mendapatkan pengetahuan tentang Surat Bisnis dalam Bahasa Inggris dan Penyusunannya, Penyusunan Surat Bisnis “letter of inquiry” dan “letter of order” dalam Bahasa Inggris, Penyusunan surat bisnis “letter of request” dan “letter of reservation” dalam Bahasa Inggris, Penyusunan
                        surat bisnis “letter of confirmation” dan “letter of reminder” dalam Bahasa Inggris, Penyusunan surat bisnis “adjustment/apology” dalam Bahasa Inggris.
                    </p>
                    <p class="mt-4 px-4 leading-relaxed text-gray-700 font-semibold text-xl">
                    ...
                    <p class="mt-4 px-4 leading-relaxed text-gray-700 text-lg">
                        ...
                        Kelas ini merujuk pada SKKNI Nomor 124 Tahun 2022 Tentang Manajemen Bidang Pemasaran.
                    </p>
                    <p class="mt-4 px-4 leading-relaxed text-gray-700 text-lg">
                        ...
                        <div class="max-w-xl lg:max-w-3xl">
                            ...
                            <div class="space-y-4">
                                <details class="group [&_summary::-webkit-details-marker]:hidden" open>
                                    ...
                                    <p class="px-4 leading-relaxed text-gray-700 text-lg">
                                        Ya,kamu hanya dapat membeli pelatihan pertamamu dalam waktu 15(lima belas)hari kalender
                                        setelah kamu mendapatkan pemberitahuan penetapan sebagai Penerima Kartu Prakerja dari Manajemen Pelaksana.
                                        Jika melebihi batas waktu tersebut dan kamu belum membeli pelatihan, Kartu Prakerja kamu akan dinonaktifkan/dicabut
                                        kepesertaannya dan kamu tidak dapat mengikuti kembali Program Kartu Prakerja.Saldo bantuan pelatihanmu juga akan
                                        hangus dan dikembalikan ke Rekening Negara.
                                    </p>
                                </details>
                                ...
                                <details class="group [&_summary::-webkit-details-marker]:hidden">
                                    ...
                                    <p class="px-4 leading-relaxed text-gray-700 text-lg">
                                        Bisa, namun kamu hanya boleh membeli pelatihan yang kedua setelah kamu menyelesaikan pelatihan pertama kamu
                                        dan mengisi rating ulasan. Pastikan kamu masih mempunyai sisa saldo yang cukup dan membeli pelatihan kedua
                            ...
                            <details class="group [&_summary::-webkit-details-marker]:hidden">
                                ...
                                <p class="px-2 leading-relaxed text-gray-700text-lg">
                                    3. Bukalapak: https://www.bukalapak.com/kartu-prakerja/lembaga/pt-yureka-edukasi-cipta-yeccoid-3804?source=tab-merchant
                                </p>
                                <p class="px-2 leading-relaxed text-gray-700 text-lg">
                            ...
                            <details class="group [&_summary::-webkit-details-marker]:hidden" open>
                                ...
                                <p class="px-4 leading-relaxed text-gray-700 text-lg">
                                    Saat ini,kamu hanya dapat membeli pelatihan dengan besaran sama atau kurang dari jumlah
                                    pagu kamu. Jadi,pastikan saldo kamu cukup ya untuk membeli pelatihan yang kamu mau.
                                </p>
                            </details>
                            ...
                            <details class="group [&_summary::-webkit-details-marker]:hidden" open>
                                ...
                                <p class="px-4 leading-relaxed text-gray-700 text-lg">
                                    Pastikan kamu telah memasukkan nomor Kartu Prakerja dan OTP yang benar pada saat membeli
                                    pelatihan di Platform Digital. Selain itu, pastikan juga kamu telah memenuhi kriteria untuk mengikuti pelatihan,
                                    seperti batas minimal usia dan batas minimal pendidikan.Jika masih terdapat kendala,kamu dapat menghubungngi customer servis Platform Digital:
                                </p>
                                <p class="px-2 leading-relaxed text-gray-700 text-lg">
                            ...
                            <details class="group [&_summary::-webkit-details-marker]:hidden" open>
                                ...
                                <p class="px-4 leading-relaxed text-gray-700 text-lg">
                                    Saat membeli pelatihan, pastikan bahwa saldo pelatihan kamu masih tersedia, koneksi internet
                                    stabil dan kamu telah memasukkan nomor Kartu Prakerja dan OTP yang benar. Kamu juga harus memastikan
                                    kamu memenuhi kriteria untuk mengikuti pelatihan, seperti batas minimal usia dan batas minimal pendidikan.
                                    Jika masih bermasalah, kamu bisa menghubungi customer service Mitra Platform Digital di bawah ini:
                                </p>
                                <p class="px-2 leading-relaxed text-gray-700 text-lg">
                                    1. Tokopedia: https://www.tokopedia.com/help
                                </p>
                            ...
                            <details class="group [&_summary::-webkit-details-marker]:hidden" open>
                                ...
                                <p class="px-4 leading-relaxed text-gray-700 text-lg">
                                    Untuk bisa redeem pelatihan,kamu harus melihat kode redeem yang ada bisa dilihat di email atau detail
                                    pelatihan di dashboard kamu.Buka kotak masuk email yang kamu daftarkan ke akun Prakerja.Cari email dengan kata
                                    kunci "Pembelian Pelatihan" seperti dibawah ini kamu akan menemukan kode redeem yang bisa kamu gunakan untuk redeem pelatihan.
                                </p>
                                <img src="@/assets/images/landingpage/tutor.png" class="w-full">
                                <p class="px-4 leading-relaxed text-gray-700 text-lg">
                                    Selain di email, kamu juga bisa melihat kode redeem di detail pelatihan yang sudah kamu beli di dashboard. Klik pelatihan yang sudah kamu beli di Pelatihan Saya.
                                </p>
                                <img src="@/assets/images/landingpage/cov1.png" class="w-full">
                                <p class="px-4 leading-relaxed text-gray-700 text-lg">
                                    Jika kamu membeli pelatihan yang diselenggarakan secara online, kamu bisa melihat kode redeem dengan tampilan di bawah ini.
                                </p>
                                <img src="@/assets/images/landingpage/cov2.png" class="w-full">
                                <p class="px-4 leading-relaxed text-gray-700 text-lg">
                                    Jika kamu melakukan pembelian pelatihan dari lembaga YEC.CO.ID, maka silakan akses bakat.yec.co.id untuk meredeem kode redeem tersebut. Kode redeem dan Kode voucher
                                    di bakat.yec.co.id hanya dapat diredeem minimal 1 jam sebelum jadwal yang kamu pilih dimulai, dan maksimal 1 jam setelah jadwal yang kamu pilih dimulai. Berikut tata caranya :
                                </p>
                                <p class="px-4 leading-relaxed text-gray-700 text-lg">
                                ...
                                <p class="px-4 leading-relaxed text-gray-700 text-lg">
                                    2. Kemudian masukkan kode voucher yang kamu dapatkan dari transaksi/bukti pembayaran/invoice platform digital (Tokopedia/Karier.mu/Bukalapak/Pijar Mahir/Pintar)
                                </p>
                                <img src="@/assets/images/landingpage/cov4.png" class="w-full">
                                <p class="px-4 leading-relaxed text-gray-700 text-lg">
                                    3. Kemudian klik “redeem” maka nanti kelas yang kamu beli akan muncul di menu “Kelas Saya”
                                </p>
                                <p class="px-4 leading-relaxed text-gray-700 text-lg">
                            ...
                            <details class="group [&_summary::-webkit-details-marker]:hidden" open>
                                ...
                                <p class="px-4 leading-relaxed text-gray-700 text-lg">
                                    Pastikan kamu sudah mengisi kode redeem sesuai yang tertera di email dan detail pelatihan di dashboard kamu.
                                    Jika masih ada kendala, silakan hubungi Call Center Prakerja di 08001503001
                                </p>
                            </details>
                            ...
                            <details class="group [&_summary::-webkit-details-marker]:hidden" open>
                                ...
                                <p class="px-4 leading-relaxed text-gray-700 text-lg">
                                    Ya, penerima Kartu Prakerja wajib mengikuti pre-test atau tes awal terlebih dahulu di lembaga pelatihan sebelum memulai
                                    pelatihan. Tes awal ini terdiri dari beberapa pertanyaan mengenai materi pelatihan yang kamu pilih. Tenang saja, tes awal
                                    ini hanya bertujuan untuk melihat pengetahuan awal kamu, kok!
                                </p>
                            </details>
                            ...
                            <details class="group [&_summary::-webkit-details-marker]:hidden" open>
                                ...
                                <p class="px-4 leading-relaxed text-gray-700 text-lg">
                                    Wajib, silakan on cam selama pelatihan berlangsung agar bukti kehadiran kamu dapat terecord
                                </p>
                            </details>
                            ...
                            <details class="group [&_summary::-webkit-details-marker]:hidden" open>
                                ...
                                <p class="px-4 leading-relaxed text-gray-700 text-lg">
                                    Silakan kamu mengubah nama akun zoom sesuai format di bawah ini, agar tim dapat melakukan pengecekan kehadiran:
                                </p>
                                <p class="px-4 leading-relaxed text-gray-700 text-lg">
                                    1. Untuk Peserta Kartu Prakerja: “Kartu Prakerja - Nama Lengkap Peserta Sesuai KTP”
                                </p>
                                <p class="px-4 leading-relaxed text-gray-700 text-lg">
                            ...
                            <details class="group [&_summary::-webkit-details-marker]:hidden" open>
                                ...
                                <p class="px-4 leading-relaxed text-gray-700 text-lg">
                                    Kamu harus memastikan koneksi jaringan stabil saat mengambil pelatihan dan coba menggunakan perangkat lain terlebih dahulu.
                                    Jika kamu masih mengalami kendala, kamu bisa menghubungi CS YEC.CO.ID khusus pelatihan Prakerja di +62 853-3584-9962 (WhatsApp chat)
                                </p>
                            </details>
                            ...
                            <details class="group [&_summary::-webkit-details-marker]:hidden" open>
                                ...
                                <p class="px-4 leading-relaxed text-gray-700 text-lg">
                                    Sertifikat pelatihan akan muncul di dashboard kamu setelah menyelesaikan pelatihan paling lambat satu hari kerja
                                    sesudah Manajemen Pelaksana menerima laporan penyelesaian pelatihan dari Platform Digital. Jika sertifikat belum muncul di dashboard lebih dari 7 (tujuh) hari kerja.
                                </p>
                            </details>
                            ...
                            <details class="group [&_summary::-webkit-details-marker]:hidden" open>
                                ...
                                <p class="px-4 leading-relaxed text-gray-700 text-lg">
                                    Sertifikat pelatihan diterbitkan langsung oleh Lembaga Pelatihan. Jika ada kekeliruan dalam penulisan nama di sertifikat pelatihan,
                                    kamu bisa menghubungi Lembaga Pelatihan untuk konfirmasi lebih lanjut. Selain itu, pastikan kamu menggunakan nama asli kamu di profil akun
                                    Platform Digital dan akun bakat.yec.co.id agar nama di sertifikat sama dengan nama aslimu (jika kamu melakukan pembelian pelatihan dari YEC.CO.ID)
                                </p>
                            </details>
                            ...
                            <details class="group [&_summary::-webkit-details-marker]:hidden" open>
                                ...
                                <p class="px-4 leading-relaxed text-gray-700 text-lg">
                                    Setelah menyelesaikan pelatihan dan mendapatkan sertifikat, kamu harus segera mengisi rating dan
                                    ulasan pelatihan di dashboard kamu. Pastikan kamu memberikan rating dan ulasan dengan jujur sesuai pengalaman pelatihan kamu
                                </p>
                            </details>
                            ...
                            <details class="group [&_summary::-webkit-details-marker]:hidden" open>
                                ...
                                <p class="px-4 leading-relaxed text-gray-700 text-lg">
                                    1. Cek Pelatihan Saya di dashboard kamu dan pastikan tombol Tulis Ulasan sudah aktif dan berwarna biru. Kilik tombol tersebut
                                </p>
                                <p class="px-4 leading-relaxed text-gray-700 text-lg">
                                    2. Akan muncul pop up untuk mulai mengisi ulasan. Klik Mulai Beri Ulasan
                                </p>
                                <p class="px-4 leading-relaxed text-gray-700 text-lg">
                                    3. Pilih bintang untuk mengisi rating sesuai dengan tingkat kepuasanmu saat mengikuti pelatihan. Bintang 1 (satu) artinya kamu sangat tidak puas
                                    dan bintang 5 (lima) artinya kamu sangat puas. Jika sudah memberi rating, klik Lanjut
                                </p>
                                <p class="px-4 leading-relaxed text-gray-700 text-lg">
                                    4. Tulis ulasan dengan jujur untuk meningkatkan kualitas pelatihan yang kamu ambil. Jika sudah, klik Lanjut
                                </p>
                                <p class="px-4 leading-relaxed text-gray-700 text-lg">
                                    5. Cek kembali rating dan ulasan yang sudah kamu isi. Pastikan ya sudah sesuai dengan pengalaman kamu selama mengikuti pelatihan! Jika sudah sesuai, klik Kirim
                                </p>
                            </details>
                            ...
                            <details class="group [&_summary::-webkit-details-marker]:hidden" open>
                                ...
                                <p class="px-4 leading-relaxed text-gray-700 text-lg">
                                    Kamu tetap akan menerima insentif selama kamu sudah menyelesaikan pelatihan yang ditandai dengan sertifikat penyelesaian
                                    pelatihan serta mengisi rating dan ulasan di dashboard Prakerja kamu. Nilai tes akhir pelatihan kamu hanya digunakan untuk menilai pemahaman kamu terhadap pelatihan yang telah diikuti.
                                </p>
                            </details>
